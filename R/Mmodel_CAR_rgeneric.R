...
#'
#'
#'   model <- inla.rgeneric.define(inla.rgeneric.Mmodel.model,
#'     debug = TRUE,
#'     k = k, W = W, alpha.min = alpha.min,
#'     alpha.max = alpha.max
#'   )
#'
#'   r.Mmodel <- inla(OBS ~ -1 + f(idx, model = model),
#'     data = d, E = EXP,
...
#'   )
#'   dev.new()
#'   plot(nc.sids$FITTED74.uni, nc.sids$Fit1,
